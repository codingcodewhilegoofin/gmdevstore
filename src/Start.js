...
export default function Scene({ ...props }) {
  ...
  return (
    <>
      ...
      <fog attach="fog" args={['#000000', 1307.692, 2000]} />
      <group {...props} dispose={null}>
        <group
          name="CHARACTER_Shrek"
          position={[-2367.51, -246.52, -40.29]}
        ...
        <group name="Text 20170707201832" position={[-977.39, 9.49, -507.04]} scale={[1, 1, 2.07]}>
          <mesh
            name="C1"
            geometry={nodes.C1.geometry}
            material={materials['My Text Material']}
        ...
        <PerspectiveCamera
          ...
          near={5}
          fov={45}
          position={[-924, 129, 1459]}
        />
        <pointLight
          name="Point Light 20170707201830"
          castShadow
          intensity={0.23}
          decay={2}
          distance={2128}
          ...
          color="#d7dfdf"
          position={[-795.05, -282.13, 876.32]}
        />
        <pointLight
          name="Point Light 20170707201829"
          castShadow
          intensity={1.39}
          decay={2}
          distance={2128}
          ...
          shadow-camera-far={100000}
          color="#d7dfdf"
          position={[-918.43, 451.92, -137.83]}
        />
        <group name="20170707201828" position={[583.29, 13, 3]} rotation={[-Math.PI / 2, 0, 0]} scale={20}>
          <mesh name="1" geometry={nodes['1'].geometry} material={nodes['1'].material} castShadow receiveShadow />
        </group>
        <group name="concrete-bin" position={[-818.48, -134.72, 0]} rotation={[-Math.PI / 2, 0, -8.78]} scale={2}>
          <mesh
            name="concrete-bin1"
        ...
        <directionalLight
          ...
          position={[0, 1385, 0]}
        />
        <hemisphereLight name="Default Ambient Light" intensity={1.28} color="#465478" position={[0, 1, 0]} />
      </group>
    </>
  )
}
