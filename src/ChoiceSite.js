...
const ChoiceSite = (props) => {
  ...
  return (
    <div className="choicediv" style={{background:"rgb(36, 42, 54)" , textAlign:"center"}}>
        <h1 style={{color:"red",backgroundColor:"black" }}> Welcome to Giomoscato.com
        </h1>
        <h3 style={{color:"white" }}> I have built 2 different web experiences!
        </h3>
        ...
        <h2 style={{color:"white" }}> Overall both site versions are meant to demonstrate my web/dev skills.
