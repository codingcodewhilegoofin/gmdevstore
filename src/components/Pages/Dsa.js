...
const Dsa = () => {
  ...
  // ******************************************************* Perform algo on data structure ***********************************************************
  // Array function to handle form submit and choose sorting or searching algorithm (A)
  const array = (e) => {
    e.preventDefault();
    console.log(
      "Algorithm chosen\n",
    ...
    if (linearSearch) {
      ...
      setChangeArray(
        ...
        >
          ...
          <h1
            style={{ color: "black", paddingLeft: "5px", fontWeight: "bold" }}
          >
            Search element
          </h1>
          <div
      ...
      if (
        ...
        setTimeout(() => {
          setArrayMessage();
          setArrayMessage(
            `Now searching array with search element x = \n${linearSearchElement}`
          );
        ...
        setTimeout(() => {
          ...
          colorFlag = 0;
          setArrayMessage(
            `Step 1: Start from leftmost element of array and one by one compare \n${linearSearchElement} with each element of array `
          );
          //1 Start from the leftmost element of arr[] and one by one compare x with each element of arr[]
          for (let i = 0; i < userArray.length; i++) {
            if (!(userArray[i] === null)) {
              if (userArray[i] === linearSearchElement) {
                setArrayMessage(
                  ` X matches element ${linearSearchElement}, found at position ${linearSearchCount}`
                );
                ...
                setArrayMessage(
                  " Search element X does not match any position in the array !"
                );
      ...
      // If user didnt enter blank values, show value, then  show meme, then reset the message...
      // Else let the user know the array is blank which is invalid 
      if (
        !((e.target[0].value || e.target[1].value || e.target[2].value) === "")
      ) {
  ...
  return (
    ...
    >
      ...
      <div
        className="dsaMenu"
        style={{
          boxShadow: "rgba(17, 12, 46, 0.15) 0px 48px 100px 50px",
          width: `${cardWidth}`,
          marginTop: "20px",
          marginBottom: "20px",
      ...
      >
        ...
        >
          All DS follow 4 basic operations. <br />
          <b>Access, Searching, Inserting, and Deletion</b>.<br /> Some perform
          better than others. This is judged by Time & Space complexity. We test
          the lower bound of each DS to find worst & average cases. The notation
          to describe this is referred to as <br />
          BIG O.
        </h4>
      ...
      {menuArray ? (
        ...
        >
          ...
          >
            {memeArray}
            <h2 style={{ color: "black" }}>{arrayElements}</h2>
            <h2 style={{ color: "black" }}>{changeArray}</h2>
            <h2 style={{ color: "black" }}>{arrayMessage}</h2>
          </div>
                ...
                >
                  ...
                  {!linearSearch ? (
                    ...
                    <>
                      ...
                      <label style={{ color: "white", fontSize: "large" }}>
                  ...
                  >
                    ...
                    {!selectionSort ? (
                      ...
                      >
                        ...
                        <br /> but underperforms compared to bubble sort
                      </label>
                    )}
                  </div>
                  ...
                  >
                    ...
                    {!bubbleSort ? (
                      ...
                      >
                        ...
                        bubble sort is often used to introduce
                        <br /> the concept of a sorting algorithm.
                      </label>
                    )}
                  </div>
