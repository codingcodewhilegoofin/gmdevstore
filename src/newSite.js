...
export default function NewSite({ ...props }) {
    ...
    return (
        <>
            {!renderFinished ?
                <>
                    <div id="canvas-container" style={{ borderRadius: '20px' }} >
                        <DrawerMenu />
                                ...
                                <SelectToZoom>
                                    ...
                                    <group {...props} dispose={null}>
                                        ...
                                        <mesh
                                            ...
                                            geometry={nodes['giomoscato.com.png'].geometry}
                                            material={materials['giomoscato.com.png Material']}
                                            castShadow
                                            receiveShadow
