    ...
    <div >
      <div className="gio-container-1" style={{ padding: '5px' }}>
        ...
        <ul style={{ color: '#AEBEBEff', textAlign:"center" }}>
         ...
         <div style={{ border: '2px solid #AEBEBEff', borderRadius: '5px', margin: '10px', backgroundColor: '#1B2524ff' }}>
          <h1 style={{ color: '#AEBEBEff', fontWeight: '900', backgroundColor: '#1B2524ff' }}>  Spotify API data</h1>
        ...
        {gioDataToggle ? <></> :
          <div className="gio-container" style={{  padding: '10px', backgroundColor: '#101730ff', }}>
