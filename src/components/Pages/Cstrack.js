...
const Cstrack = () => {
    ...
    if (windowSize < 600) {
        divSection1 = <div className='end-div3' style={{ padding: '10px', margin: '10px' }}><img src={OpenSea} width='50%' height='auto' style={{ marginLeft: '10px' }} /><img src={poly} width='50%' height='auto' style={{ marginRight: '10px' }} /></div>;
        divSection2 = <div className='end-div3' style={{ padding: '10px', margin: '10px' }}><img src={alpha} width='33%' height='auto' style={{ margin: '5px', marginLeft: '10px' }} /><img src={Coiblib} width='33%' height='auto' style={{ margin: '5px' }} /><img src={mash} width='33%' height='auto' style={{ margin: '5px', marginRight: '10px' }} /></div>;
    }
    else {
        divSection1 = <div className="gio-container" style={{ margin: '30px' }}><div className='end-div3' style={{ padding: '1px', width: '60%', background: 'none', border: 'none' }}><img src={OpenSea} width='20%' height='100%' style={{ margin: '5px' }} /><img src={poly} width='20%' height='auto' style={{ margin: '5px' }} /><img src={alpha} width='15%' height='auto' style={{ margin: '5px' }} /><img src={Coiblib} width='15%' height='auto' style={{ margin: '5px' }} /><img src={mash} width='15%' height='auto' style={{ margin: '5px' }} /></div></div>;
        divSection2 = <></>;
    }
    ...
    return (
        ...
        <div
            ...
            <div className='gio-container-2' style={{ margin: '10px' }}>
                ...
                <h4 style={{ padding: '10px', lineSpacing: '5px', borderRadius: '10px' }}> API's provided by </h4>
            </div>
