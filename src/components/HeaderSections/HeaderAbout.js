...
function HeaderAbout() {
  ...
  return (
    <>
      ...
      <div className='gio-main' style={{ border: 'none', padding: '0px', margin: '0px', width: `${ProjectCardWidth}`  }} >

        <div className='subheader7' style={{ borderRadius: '20px'  }} >
        ...
        <div className='gio-container-2' style={{ boxShadow: 'rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset', border: 'none', padding: '3px',  }}>
          ...
          <h4 id="languages" name="languages" style={{ borderRadius: '20px', fontWeight: '900', fontSize: `${FontSizeLarge}`, fontWeight: '900' }}>LANGUAGES & ENV's: </h4>
        ...
        <div className='gio-container-4' style={{ boxShadow: 'rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset', border: 'none', padding: '3px', }}>
          <h4 style={{ borderRadius: '20px', fontWeight: '900', fontSize: `${FontSizeMedium}`}}>CODE/PACKAGE<br/> MANAGMMENT</h4>
          <ul style={{ background: 'rgba(0,0,0,.8)' }}>
            <div className="end-div2" style={{ background: 'white' }} >
              <li >GITHUB/GIT:</li>
            </div>
        ...
        <div className='gio-container' style={{ background: 'black', boxShadow: 'rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset', border: 'none', padding: '3px', }}>

          <h4 style={{ backgroundColor: 'black' ,fontSize:`${FontSizeLarge}`, color: 'orange'}}>What was code orange <br/>( DFS ): </h4>
        ...
        <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
          <div className='gio-container-4' style={{ width: '85%', boxShadow: 'rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset', border: 'none', padding: '3px', }}>
            <h4 style={{ borderRadius: '20px', fontWeight: '900' , fontSize: `${FontSizeMedium}`}}>Minor in mathematics </h4>
            <ul style={{ background: 'rgba(0,0,0,.8)' }}>
              <br />
              <div className="end-div3" >
